...
⚠️ The routine is used to correct NIRCam image observations and NIRSpec data cubes. However, it cannot yet correct MIRI images and MRS data. A future version including this is planned. 
